...
type OnSave = <T extends HtmlOutputType>(output: Output<T>) => void;
...
type Init<T extends HtmlOutputType> = (
  token: string,
  config: Config<T>,
  cb: CB
) => void;
